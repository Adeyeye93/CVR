...
chrome.runtime.onInstalled.addListener(async (details) => {
  if (details.reason === "install") {
    ...
    chrome.tabs.create({
      url: "meetingtv.us/cvrwelcome",
    });

    const locale = chrome.i18n.getMessage("@@ui_locale");
    if (locale.includes("en")) {
      chrome.runtime.setUninstallURL(
        "meetingtv.us/cvruninstall=" + chrome.runtime.getManifest().version
      );
    } else {
      chrome.runtime.setUninstallURL(
        "http://translate.google.com/translate?js=n&sl=auto&tl=" +
          locale +
          "&u=meetingtv.us/cvruninstall=" +
...
chrome.runtime.onMessage.addListener((request, sender, sendResponse) => {
  if (request.type === "desktop-capture") {
    ...
    createTab(
      "meetingtv.us/cvrhelp/editing-and-exporting/dJRFpGq56JFKC7k8zEvsqb/why-is-there-a-5-minute-limit-for-editing/ddy4e4TpbnrFJ8VoRT37tQ",
      true,
      true
    );
  } else if (request.type === "upgrade-info") {
    createTab(
      "meetingtv.us/cvrhelp/getting-started/77KizPC8MHVGfpKpqdux9D/what-are-the-technical-requirements-for-using-screenity/6kdB6qru6naVD8ZLFvX3m9",
      true,
      true
    );
  } else if (request.type === "trim-info") {
    createTab(
      "meetingtv.us/cvrhelp/editing-and-exporting/dJRFpGq56JFKC7k8zEvsqb/how-to-cut-trim-or-mute-parts-of-your-video/svNbM7YHYY717MuSWXrKXH",
      true,
      true
    );
    ...
    createTab("meetingtv.us/cvrhelp/", true, true);
